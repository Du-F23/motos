            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row mt-4">
                                                    ...
                                                    <div class="container">
                                                        <form action="{{ route('categories.store') }}"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <label class="col" for="name">Nombre de la
                                                                    Categoria:</label>
                                                                <input id="name" class="col form-control"
                                                                       type="text" name="name" placeholder="Deportiva"
                                                                       required>
                                                                <label for="forProducts" class="form-label">¿Es para Productos?</label>
                                                                <select class="form-select"
                                                                        aria-label="Seleccionar si la categoria es para los productos" name="forProduct">
                        ...
                        @if($categoriesForProducts->count() !== 0)
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-gradient-primary shadow-primary rounded pt-4 pb-3">
                                            <h6 class="text-white text-capitalize ps-3">Lista De Categorias para Productos</h6>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
